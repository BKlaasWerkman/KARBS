...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/bklaaswerkman/linux-dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/BKlaasWerkman/KARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Klaas's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Klaas" 10 60
...
sed -Ei "s/^#(ParallelDownloads).*/\1 = 5/;s/^#Color$/s/#//" /etc/pacman.conf
